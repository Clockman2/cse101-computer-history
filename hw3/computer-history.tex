...
All software uses RAM. The reason for this is because that RAM is what stores applications. The application gets stored in binary bits to the hard drive on your computer. The computer reads the bits and displays it on your screen as programs. 
\section{CONCLUSION}
